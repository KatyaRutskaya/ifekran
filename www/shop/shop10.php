...
<html>
<head>
<title>Автоэлектроника для УралАЗ</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Автоэлектроника для УралАЗ</h2>
			</div>
		</div>
	</div>
	</section>

	<body data-page="catalogDB10">
	    <div class="container">
...
<footer>
        ...
        <script src="js/modules/catalogDB10.js" type="text/javascript"></script>
        <script src="js/modules/cart.js" type="text/javascript"></script>
        <script src="js/modules/compare.js" type="text/javascript"></script>
        <script src="js/modules/main10.js" type="text/javascript"></script>
