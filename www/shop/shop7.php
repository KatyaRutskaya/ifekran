...
<html>
<head>
<title>Автоэлектроника для МТЗ</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Автоэлектроника для МТЗ</h2>
			</div>
		</div>
	</div>
	</section>

	<body data-page="catalogDB7">
	    <div class="container">
...
<footer>
        ...
        <script src="js/modules/catalogDB7.js" type="text/javascript"></script>
        <script src="js/modules/cart.js" type="text/javascript"></script>
        <script src="js/modules/compare.js" type="text/javascript"></script>
        <script src="js/modules/main7.js" type="text/javascript"></script>
