...
<html>
<head>
<title>Автоэлектроника для КрАЗ</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Автоэлектроника для КрАЗ</h2>
			</div>
		</div>
	</div>
	</section>

	<body data-page="catalogDB4">
	    <div class="container">
	        <br />
...
<footer>
        ...
        <script src="js/modules/catalogDB4.js" type="text/javascript"></script>
        <script src="js/modules/cart.js" type="text/javascript"></script>
        <script src="js/modules/compare.js" type="text/javascript"></script>
        <script src="js/modules/main4.js" type="text/javascript"></script>
