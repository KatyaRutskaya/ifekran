...
<html>
<head>
<title>Автоэлектроника для ГОМСЕЛЬМАШ</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Автоэлектроника для ГОМСЕЛЬМАШ</h2>
			</div>
		</div>
	</div>
	</section>

	<body data-page="catalogDB2">
	    <div class="container">
	        <br />
...
<footer>
        ...
        <script src="js/modules/catalogDB2.js" type="text/javascript"></script>
        <script src="js/modules/cart.js" type="text/javascript"></script>
        <script src="js/modules/compare.js" type="text/javascript"></script>
        <script src="js/modules/main2.js" type="text/javascript"></script>
