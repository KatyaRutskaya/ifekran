...
<html>
<head>
<title>Автоэлектроника для МАЗ</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Автоэлектроника для МАЗ</h2>
			</div>
		</div>
	</div>
	</section>

	<body data-page="catalogDB5">
	    <div class="container">
...
<footer>
        ...
        <script src="js/modules/catalogDB5.js" type="text/javascript"></script>
        <script src="js/modules/cart.js" type="text/javascript"></script>
        <script src="js/modules/compare.js" type="text/javascript"></script>
        <script src="js/modules/main5.js" type="text/javascript"></script>
