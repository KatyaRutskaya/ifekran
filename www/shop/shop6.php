...
<html>
<head>
<title>Автоэлектроника для ММЗ</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Автоэлектроника для ММЗ</h2>
			</div>
		</div>
	</div>
	</section>

	<body data-page="catalogDB6">
	    <div class="container">
...
<footer>
        ...
        <script src="js/modules/catalogDB6.js" type="text/javascript"></script>
        <script src="js/modules/cart.js" type="text/javascript"></script>
        <script src="js/modules/compare.js" type="text/javascript"></script>
        <script src="js/modules/main6.js" type="text/javascript"></script>
