...
mysql_select_db("ekran"); // имя бызы // Подключает файл с логином/паролем и именем БД
mysql_set_charset('utf8'); // Устанавливает кодировку клиента
$sql_select = "SELECT * FROM  `автоэлектроника для белкоммунмаш`LIMIT 0 , 30"; // Выбираем таблицу из которой читать данные
