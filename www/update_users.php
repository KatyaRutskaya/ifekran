...
$var = mysql_fetch_assoc(mysql_query("SELECT * FROM `users` WHERE`id` = $id"));
    ...
    <div class="home-page" id="wrapper">
        ...
        <header>
          ...
          <div class="container">
             ...
             <br>
             <br>
             <h3 class="mt-4 mb-3">Изменить пользователя</h3>

             <form action="save_users.php" method="post" class="row g-3">
