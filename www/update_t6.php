...
$var = mysql_fetch_assoc(mysql_query("SELECT * FROM `img` WHERE`id` = $id"));
    ...
    <div class="home-page" id="wrapper">
        ...
        <header>
          ...
          <div class="container">
            ...
            <form action="save_img.php" method="post" class="row g-3">
              <input type="hidden" value="<?php
               ...
               <div class="col-md-9">
                 ...
                 echo $var["image"];
                 ?>" id="var-title" placeholder="Email">
               </div>
               <div class="col-md-9" id="text-form">
             ...
             <!-- <input type="hidden" value="<?php
               ...
               <div class="col-md-6">
                 <label for="var-title" class="form-label">Название переменной</label>
                 <input type="text" name="mesto" class="form-control" value=" <?php
                 echo $var["mesto"];
                 ?>" id="var-title">
               </div>
               ...
               <div class="col-md-12 d-none" id="image-form">
                <br>
                 ...
                 <input type="image" name="image" class="form-control" value=" <?php
                 echo $var["image"];
